...
public class NotificationController : ControllerBase
{
    ...
    ///         "File": "IFile" // Является не обязательным если используется форма ввода Body. Данная форма для загрузки файла, которая ожидает на вход .cvs или .xls c набором данных кому отправлять нотификацию
    ///     }
    /// </remarks>
